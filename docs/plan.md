...
- [x] Badge - 完成徽章组件，支持显示数字、文本、小圆点，提供最大值限制、自定义位置、偏移、边框和颜色等功能，完美适配深色/浅色主题
...
- [x] Select - 完成选择器组件，支持单选多选模式、自定义模板、自定义下拉菜单头部底部、分组、筛选选项、远程搜索、创建新选项、自定义标签、折叠标签、自定义宽度等功能，完美集成了Element Plus的el-select和el-select-v2的全部功能，并加入了流畅的动画效果
